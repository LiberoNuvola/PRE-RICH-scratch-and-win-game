...
-- | LEGACY ONLY. Not the PRE-RICH V1 randomness source.
...
-- ============================================================
-- Validator (legacy migration paths only)
-- ============================================================
  ...
  in
    ...
    && case action of
         ...
         RevealSeed seed salt newCommitment ->
           let commitmentOk =
                 seedCommitment seed salt == ppNextCommitment datum
           in
                lengthOfByteString seed > 0
