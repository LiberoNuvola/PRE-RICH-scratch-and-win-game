...
protocolVersion =
sha2_256
( appendByteString (field gameRoundCommitmentDomain)
$ appendByteString (field gameId)
$ appendByteString (fieldInteger roundId)
$ appendByteString (field configHash)
...
sha2_256
(appendByteString (field symbolsDomain) (field ticketSeed))